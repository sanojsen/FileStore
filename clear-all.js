...
console.log('   • All files from MongoDB database');
console.log('   • All files from R2 bucket storage');
console.log('   • This action CANNOT be undone!');
console.log('');

rl.question('Are you absolutely sure? Type "DELETE EVERYTHING" to confirm: ', (answer) => {
  if (answer === 'DELETE EVERYTHING') {
    console.log('🔥 Confirmed! Starting complete cleanup...\n');
    clearAll();
  } else {
